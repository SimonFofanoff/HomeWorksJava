public class Lesson2 {
    public static void main(String[] args) {
        ...
        OneNumber(1);
        Task3(5);
        Task4("Очень важное сообщение", 5);
    }
    ...
    public static boolean Task3(int z){
        boolean w = z < 0;
        if (w)
            return true;
        else
    ...
    public static void Task4(String message, int a){
        for(int b = 0; b < a; b++){
...
Если выполнение задач вызывает трудности, можете обратиться к последней странице методического пособия. Для задач со * не нужно
* искать решение в интернете, иначе нет смысла их выполнять.*/